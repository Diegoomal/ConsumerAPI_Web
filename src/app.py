...
def main():
    st.set_page_config(page_title="Envio de Imagem", page_icon=None,
    ...
    uploaded_file = st.file_uploader("Escolha uma imagem para enviar",
                                     type=["jpg", "png", "jpeg"])
    ...
    if st.button("Descobrir rótulo") and uploaded_image is not None:
        ...
        st.text(ebeer.DataLabel[n_pos]["name"])
